...
insert into demo_business_seed values
  ('demo-cafe-central-u', 'Cafe Central U', 'comida-bebidas', 'Cafe universitario con desayunos, jugos naturales y almuerzos rapidos cerca del campus.', 'approved', true, 'Bs 8-35', 'Promocion de cafe + sandwich hasta las 11:00.', '07:30', '19:30', true, true, 'Delivery dentro y cerca del campus.', 'Bloque central, frente a la biblioteca', 'Campus central', -16.503120, -68.132420, '59170010001', 'https://instagram.com/cafe.central.u'),
  ('demo-burger-patio', 'Burger Patio', 'comida-bebidas', 'Hamburguesas artesanales, papas y combos pensados para pausas entre clases.', 'approved', true, 'Bs 18-45', 'Combo estudiante activo durante la tarde.', '11:00', '21:00', true, true, 'Recojo en patio o entrega en puertas principales.', 'Patio de comidas, mesa 4', 'Patio principal', -16.503850, -68.131750, '59170010002', 'https://instagram.com/burger.patio'),
  ('demo-snack-lab', 'Snack Lab', 'snacks-dulces', 'Snacks, dulces importados, galletas y bebidas frias para estudiantes.', 'approved', false, 'Bs 3-22', 'Reposicion diaria de snacks populares.', '08:00', '20:00', false, true, null, 'Pasillo de laboratorios, modulo B', 'Laboratorios', -16.504220, -68.133120, '59170010003', 'https://instagram.com/snack.lab'),
  ('demo-postres-de-la-u', 'Postres de la U', 'snacks-dulces', 'Brownies, tortas por porcion y postres caseros por encargo corto.', 'pending_review', false, 'Bs 6-28', 'Nuevo emprendimiento en revision.', '09:30', '18:00', true, true, 'Entrega coordinada por WhatsApp.', 'Entrada lateral de cafeteria', 'Cafeteria', -16.502810, -68.130980, '59170010004', null),
  ('demo-print-fast', 'Print Fast Campus', 'fotocopias-impresiones', 'Impresiones, fotocopias, anillados y escaneos para trabajos universitarios.', 'approved', true, 'Bs 1-25', 'Impresiones listas en menos de 20 minutos.', '07:00', '20:00', false, true, null, 'Modulo de servicios, local 2', 'Servicios', -16.503500, -68.134020, '59170010005', 'https://instagram.com/printfast.campus'),
  ('demo-copias-nocturnas', 'Copias Nocturnas', 'fotocopias-impresiones', 'Servicio de impresion nocturna con recojo temprano para entregas urgentes.', 'approved', false, 'Bs 1-30', 'Pedidos hasta las 22:00 para recojo temprano.', '18:00', '23:00', true, true, 'Delivery cerca de residencias estudiantiles.', 'Residencias universitarias, puerta norte', 'Residencias', -16.501980, -68.132010, '59170010006', null),
  ('demo-outfit-campus', 'Outfit Campus', 'ropa-accesorios', 'Poleras, gorras, tote bags y accesorios con estilo universitario.', 'approved', true, 'Bs 25-120', 'Descuento por compra grupal.', '10:00', '19:00', true, true, 'Entrega por puntos de encuentro dentro del campus.', 'Plaza estudiantil, stand movil', 'Plaza estudiantil', -16.504760, -68.131240, '59170010007', 'https://instagram.com/outfit.campus'),
  ('demo-accesorios-killa', 'Accesorios Killa', 'ropa-accesorios', 'Collares, pulseras, llaveros y accesorios hechos a mano.', 'pending_review', false, 'Bs 10-60', 'Catalogo nuevo en revision por Garemo.', '09:00', '17:30', false, true, null, 'Hall de ingreso, mesa temporal', 'Ingreso principal', -16.502520, -68.134510, '59170010008', null),
  ('demo-tech-rescate', 'Tech Rescate', 'tecnologia-reparacion', 'Diagnostico rapido, cambio de accesorios y soporte para laptops y celulares.', 'approved', true, 'Bs 20-180', 'Revision express sin costo si reparas con nosotros.', '09:00', '20:00', false, true, null, 'Aula tecnica, bloque C', 'Bloque C', -16.505160, -68.132660, '59170010009', 'https://instagram.com/tech.rescate'),
  ('demo-auriculares-zone', 'Auriculares Zone', 'tecnologia-reparacion', 'Venta de audifonos, cargadores, cables y accesorios tecnologicos basicos.', 'approved', true, 'Bs 15-150', 'Auriculares con descuento esta semana.', '08:30', '19:00', true, true, 'Entrega en biblioteca o patio.', 'Biblioteca, primer piso', 'Biblioteca', -16.503030, -68.132930, '59170010010', 'https://instagram.com/auriculares.zone'),
  ('demo-tutorias-alfa', 'Tutorias Alfa', 'servicios-academicos', 'Apoyo en matematicas, estadistica y programacion para parciales y practicas.', 'approved', true, 'Bs 30-90', 'Cupos disponibles para grupos de 3 personas.', '08:00', '21:00', false, false, null, 'Sala de estudio 3', 'Biblioteca', -16.502870, -68.133360, '59170010011', null),
  ('demo-resumenes-pro', 'Resumenes Pro', 'servicios-academicos', 'Resumenes, mapas conceptuales y preparacion para exposiciones universitarias.', 'approved', false, 'Bs 20-70', 'Entrega digital el mismo dia segun disponibilidad.', '10:00', '22:00', true, false, 'Entrega digital por enlace y coordinacion por WhatsApp.', 'Atencion online y punto de encuentro en biblioteca', 'Digital', -16.503330, -68.132620, '59170010012', null),
  ('demo-delivery-campus-run', 'Campus Run Delivery', 'delivery', 'Mandados, recojo de comida y entrega de materiales dentro del campus.', 'approved', true, 'Bs 5-25', 'Tiempo promedio dentro del campus: 15 minutos.', '08:00', '21:30', true, false, 'Solo zonas universitarias y alrededores cercanos.', 'Punto base en porteria principal', 'Porteria', -16.502160, -68.131630, '59170010013', 'https://instagram.com/campus.run'),
  ('demo-beauty-break', 'Beauty Break', 'belleza-cuidado-personal', 'Manicure express, peinados simples y cuidado personal por reserva.', 'approved', true, 'Bs 20-90', 'Agenda disponible para viernes y sabado.', '10:00', '18:30', false, true, null, 'Salon compartido cerca del campus', 'Zona comercial', -16.504680, -68.134880, '59170010014', 'https://instagram.com/beauty.break'),
  ('demo-barber-u', 'Barber U', 'belleza-cuidado-personal', 'Cortes rapidos, perfilado y arreglo de barba para estudiantes.', 'pending_review', false, 'Bs 25-60', 'Pendiente de verificacion manual.', '09:00', '20:00', false, true, null, 'Calle lateral, local 6', 'Zona comercial', -16.505020, -68.135210, '59170010015', null),
  ('demo-digital-estudio', 'Digital Estudio', 'servicios-digitales', 'Diseno de piezas graficas, CV, portafolios y presentaciones para estudiantes.', 'approved', true, 'Bs 30-160', 'Pack CV + LinkedIn con entrega en 48 horas.', '09:00', '19:00', true, false, 'Entrega digital y revision por videollamada.', 'Atencion online con punto de reunion en sala cowork', 'Cowork', -16.503970, -68.130610, '59170010016', 'https://instagram.com/digital.estudio'),
  ('demo-streaming-legal', 'Servicios Digitales Campus', 'servicios-digitales', 'Asesoria de herramientas digitales, configuracion de cuentas propias y soporte basico.', 'pending_review', false, 'Bs 15-80', 'Servicio digital en revision por moderacion.', '10:00', '18:00', true, false, 'No se permite reventa de cuentas ni practicas no autorizadas.', 'Atencion online', 'Digital', -16.502750, -68.130310, '59170010017', null),
  ('demo-foto-express', 'Foto Express U', 'otros', 'Fotografia para eventos, fotos carnet y cobertura de actividades universitarias.', 'approved', true, 'Bs 15-250', 'Fotos carnet listas el mismo dia.', '09:00', '18:00', false, true, null, 'Jardin central, punto movil', 'Jardin central', -16.503670, -68.132030, '59170010018', 'https://instagram.com/foto.express.u'),
  ('demo-libros-circular', 'Libros Circular', 'otros', 'Compra, venta e intercambio de libros usados y apuntes fisicos.', 'approved', false, 'Bs 10-120', 'Semana de intercambio de libros activa.', '08:30', '17:30', false, true, null, 'Mesa de intercambio junto a biblioteca', 'Biblioteca', -16.502960, -68.133710, '59170010019', null),
  ('demo-craft-campus', 'Craft Campus', 'otros', 'Regalos personalizados, stickers, tazas y detalles para fechas especiales.', 'approved', true, 'Bs 8-95', 'Pedidos personalizados con 24 horas de anticipacion.', '09:30', '19:30', true, true, 'Entrega dentro del campus por punto de encuentro.', 'Plaza de arte estudiantil', 'Plaza estudiantil', -16.504350, -68.131910, '59170010020', 'https://instagram.com/craft.campus');
